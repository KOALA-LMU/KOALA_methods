...
is usually ignored. Often e.g., a coalition -- i.e. a union of multiple parties, formed to reach a governing majority -- is stated to ``lose'' its majority just because the joint poll share drops under 50\% (cf. \cite{umfrage_2017}).
...
Prior to the German federal elections 2013 and 2017, results based on (an earlier iteration of) our approach already entered general media reporting (cf. \cite{wahlistik_2013}, or \cite{gelitz_2017}).
...
Our approach is to be differentiated from prediction-aimed methods (cf. \cite{graefe_2017} or \cite{norpoth_gschwend_2010}) as potential shifts until election day are not taken into consideration.
