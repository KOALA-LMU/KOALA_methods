...
\subtitle{A opinion poll based "now-cast" of probabilities of events in multi-party electoral systems}
...
of party shares, our method can be applied to specific questions related to the
...
% bEsipiel könnte wegfallen, wenn Paltz gebraucht wird
