...
the distribution of the observed vote counts $\mathbf{x}^\T=(x_1,\ldots,x_P)$ is
...
in the redistributed party share can make an immense difference regarding the
...
Furthermore, the development of the redistributed party shares and the corresponding POEs
nicely highlights another advantage of using such probabilities. The POEs do not
only take into account joint party shares and sample uncertainty, but also
...
drop is caused by a growing uncertainty of the FDP passing into parliament.
...
% \begin{figure}[H]\centering
% \begin{tabular}{ll}
% \includegraphics[height=.2\textwidth]{figures/2013_pooled_cdufdp_rawSharesRedist.pdf}
% &
% \multirow{2}{*}[18.3ex]{\includegraphics[height=40ex]{figures/2013_pooled_cdufdp_ridgeline.pdf}}
% \\
% \includegraphics[height=.2\textwidth]{figures/2013_pooled_cdufdp_prob.pdf}
% \end{tabular}
% \caption{Prospect of the coalition Union-FDP to obtain a government majority before the
