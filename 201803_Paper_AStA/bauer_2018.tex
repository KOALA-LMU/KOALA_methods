...
\end{tabular}
\caption{\red{De linken Grafikn no beschreim} Development of $10\,000$ simulated parliament seat share densities for the coalition Union-FDP before the German federal election in September 2013 based on Forsa opinion polls. The parts of the densities encoding for seat majorities are colored blue.
\label{fig:seatDist_time}
}
\end{figure}

\red{No de Darstellung in Figure. \ref{fig:seatDist_time} eifuehrn und de angepasste prob-Skala erklaern.}
...
2013 and 2017, also in general media (see XXX). To underline the differences
between standard media reporting on opinion polls and our approach, we in the
following compare opinion polls before these two elections, either based on
evaluating the raw observed shares after redistribution and using Bayesian
probabilities.

As noted above we use a timeframe of 14 days for calculating the pooled survey results.
...
\end{tabular}
\caption{\red{caption. CDU-FDP coalition}
...
\end{tabular}
\caption{\red{caption. FDP passing hurdle}
\label{fig:2013_fdp}
}
\end{figure}
...
\begin{figure}[H]\centering
\begin{tabular}{ll}
\includegraphics[height=.15\textwidth]{figures/2013_pooled_spdleftgreens_rawSharesRedist.pdf}
&
\multirow{2}{*}[13ex]{\includegraphics[height=30ex]{figures/2013_pooled_spdleftgreens_ridgeline.pdf}}
\\
\includegraphics[height=.15\textwidth]{figures/2013_pooled_spdleftgreens_prob.pdf}
\end{tabular}
\caption{\red{caption. SPD-Left-Greens coalition}
\label{fig:2013_spdleftgreens}
}
\end{figure}
...
FDP was not as clear at the 5\% hurdle, compared to the 2013 federal election. Therefore,
we do not look at such event probabilities.
...
\end{tabular}
\caption{\red{caption. AfD third biggest party}
\label{fig:2017_afd}
}
\end{figure}
