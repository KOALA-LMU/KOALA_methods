...
the general population (\textcolor{red}{CITATION Stichproben Buch}). Given one (pooled) survey,
...
As previously mentioned, (an earlier iteration of) our method entered media reporting
...
A key role played the FDP, which had to successfully pass into parliament,
...
% man könnte überlegen, hier auf den ersten Satz zu verzichten und mit "By comparison" zu beginnen
...
Monte Carlo based method to estimate POEs (probailities of events for
...
surveys and reduces sample uncertainty. As the examination of indivdiual polls
