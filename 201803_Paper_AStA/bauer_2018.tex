...
\includegraphics[width=0.35\textwidth]{figures/bauer_2013_cdufdp_lastPreelectionPoll.pdf}
...
\begin{figure}[!ht]\centering
\includegraphics[width=0.4\textwidth]{figures/bauer_2013_fdp_rawShare.pdf}
\includegraphics[width=0.4\textwidth]{figures/bauer_2013_cdufdp_time.pdf}
\caption{\red{De linke Grafik no beschreim} Development of $10,000$ simulated parliament seat share densities for the coalition Union-FDP before the German federal election in September 2013 based on Forsa opinion polls. The parts of the densities encoding for seat majorities are colored blue.
\label{fig:seatDist_time}
}
\end{figure}

\red{An FDP-Verlauf a mit soichane Verlaufs-Dichteplots darstein, damit ma de W'keit sigt, dass de FDP ins Parlament kimt}
...
\section{Application to the German federal elections 2013 and 2017} \label{sec:application}
\red{Ideen:}
\begin{itemize}
  \item Unsere Ergebnisse fia de letztn zwoa Wahlen darstaein und diskutiern
  \item Jeweils an Plot vo de kumulierten, umverteilten W'keiten vo Schwarz-Gelb ois Linienplot ueber de Zeit. Und drunter/danem an Verlauf vo unsre W'keiten ueber de Zeit, mit unsrer opasstn Skala. Des Ganze ko ma dann a mit verschiedene Stichprobenumfaenge macha, um de Unterschiede zum zoang.
  \item Auf de Darstellung 'Wia aendern si de W'keiten, wenn de FDP naeher/weiter weg vo 5\% is?' dad si da Andre erstmoi ned konzentriern, sondern wirklich einfach de Ergebnisse vo de Wahlen 2013 und 2017 berichtn
  \item Idee Andre: A unser Interaktive Sach evtl berichtn, wia ma Unsicherheiten an den Endnutzer vermitteln kon
  \item Des wos ma auf Twitter dargstaeit ham (insb de baar extra-Tweets kurz vor da Wahl) evtl a hernemma fiad publication
\end{itemize}
