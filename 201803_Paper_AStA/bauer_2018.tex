...
focusing on probabilities of coalition majorities {\it if the election was held today}
and not accounting for potential shifts until election day.
...
Possible visualizations are shown and the benefit of the approach is outlined
by discussing the German federal elections 2013 and 2017.
An implementation in \texttt{R} is freely available.
