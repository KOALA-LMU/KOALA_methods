...
of $5\%$ over short periods of time and only once reached a pooled voter share
of $6\%$ (top left pane in Fig.~\ref{fig:2013_fdp}). Similarly, the probability
for the party to pass the hurdle only rarely rised over $50\%$ (bottom left pane). 
However, beginning
...
Probabilities in this regard make it easier to deduce {\it relevant} information
...
\begin{figure}[H]\centering
\begin{tabular}{llll}
\includegraphics[height=.1\textwidth]{figures/2013_pooled_fdp_rawShares.pdf}
&
\multirow{2}{*}[13ex]{\includegraphics[height=20ex]{figures/2013_pooled_fdp_ridgeline.pdf}}
&
\multirow{2}{*}[13ex]{\includegraphics[height=20ex]{figures/2013_pooled_cdufdp_ridgeline.pdf}}
&
\includegraphics[height=.1\textwidth]{figures/2013_pooled_cdufdp_rawSharesRedist.pdf}
\\
\includegraphics[height=.1\textwidth]{figures/2013_pooled_fdp_passingProb.pdf}
& & &
\includegraphics[height=.1\textwidth]{figures/2013_pooled_cdufdp_prob.pdf}
\end{tabular}
\end{figure}
...
Looking at the calculated seat majority probabilities together with
the simulated seat share densities instead draws a more comprehensive picture
of the situation.
While the overall development of probabilities is the same as with the redistributed voter shares,
i.e. they rose with time,
...
probabilities is depends heavily on the base level of the voter shares.
...
shares and their general uncertainty into consideration,
...
is highly uncertain and thus the overall majority probabilities of
the coalition are comparatively small, even for pooled voter shares around $50\%$.
This inclusion of the FDP-based uncertainty is nicely visualized in the
...
was to achieve majorities with coalitions apart from the grand coalition
...
in whether the party -- which in 2013 slightly missed the $5\%$ hurdle --
...
However, as the share of Union was a bit lower than in 2013,
...
and reached its maximum share of $49.8\%$ about one month
before election day.

Again, interpreting only the observed redistributed voter shares
is hard for the general public.
...
encode for an irrelevantly small majority probability.
...
below around $47.5\%$ correspond to very small success probabilities of $<1\%$,
based on the pooled effective sample sizes of around \red{XXXX}.
On the other hand, observed shares of $49\%$, $49.5\%$ and $49.8\%$
correspond to probabilities of \red{XXX, XXX and XXX}, respectively.
...
a probability of \red{XXX}.
However, two days before the election the pooled share and the probability
dropped to \red{XXX} and \red{XXX}, respectively, making a success
...
The maximum share was reached in \red{XXX} with a redistributed voter
share of \red{XXX} and a corresponding probability to obain the
parliament seat majority of \red{XXX}.
From mid/end April on, the probability again became negligibly small.
Shortly before election day, the joint share
dropped to around $41\%$ and a success at the election wasn't even
slightly possible.
...
but also holds for all other uncertainties in the data.
...
Special interest in the election lay in which party would
get the third best result after the major parties Union and SPD.
With observed voter shares of at most times over $8\%$,
the right-wing AfD could plan to pass into the German parliament
for the first time (see Fig.~\ref{fig:2017_afd}).
...
regarding AfD changed heavily. The party in January 2017 had a \red{XXX\%} lead
over Left and Greens (corresponding to a probability of \red{XXX\%}, 
dropped to a \red{XXX\% Rueckstand} compared to the Left in June (\red{XXX\%})
and rose back to a \red{XXX\%} lead over the Left and FDP shortly before election
day (\red{XXX\%}).
...
uncertainty underlying the situation.
