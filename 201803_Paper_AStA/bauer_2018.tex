...
For both elections, 2013 and 2017, we discuss the reults based on pooled surveys
and based on the major German polling agencies, i.e. \red{Allensbach ...}
...
\end{tabular}
\caption{Development of the governing possibility of the coalition SPD-Left-Greens before the German federal election in September 2013 based on pooled opinion polls.
Left top: Observed voter shares after redistribution. Left bottom: Probabilities to reach a majority of seats in parliament, based on $10\,000$ simulations. Right: Densities of simulated parliament seat shares based on $10\,000$ simulations. The parts of the densities encoding for seat majorities are colored blue.
