...
vote counts $x_j$.
\\[0.5cm]
Using \darkgray{\textbf{Monte Carlo simulations}} of election outcomes, we obtain obtain
...
We pool the most recent survey per pollilng agency within the past 14 days to reduce
...
\hspace{0.5in}
\begin{itemize}
  \item \darkgray{\footnotesize $X_{Sj}$ the observed voter number of party $j$ in survey $S$,}
