...
#   theme_bw(base_size = 20) +
#   theme(axis.title.x = element_blank())
# pdf("../2017_pooled_fdp_rawShares.pdf", width = 7.5, height = 3.5)
# gg
# dev.off()
#
# ### 2) Majority probabilities
...
#   theme_bw(base_size = 20) +
#   theme(axis.title.x = element_blank())
# pdf("../2017_pooled_fdp_PassingProb.pdf", width = 7.5, height = 3.5)
# gg
# dev.off()
#
# ### 3) ridgeline plot
...
#
# pdf("../2017_pooled_fdp_ridgeline.pdf", width = 7.5, height = 10)
# gg_shares
# dev.off()
