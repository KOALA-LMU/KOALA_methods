...
I would recommend that the author's discuss the potential sources of correlation between the agencys. There could be two potential issues regarding the
  ...
  \\ \\
  \blue{Answer}
We thank the reviewer for this detailed feedback! The issue of agency bias and
model assumptions were indeed addressed insufficiently. In the revision, we added
the new subchapter 2.4 were we discuss issues of house and industry biases as well as survey design, related issues regarding our model assumptions, and the quality of estimates.

\todo[inline]{Add direct quote of section 2.4. here + additional comments if
necessary}
...
You mention in the introduction that you applied your method to the austrian election, but do not mention them in the application section anymore. Please also make a (short) analysis of the austrian election in section 3.
  ...
  \\ \\
  \blue{Answer} We fully agree that including the Austria reference without
  further mentioning it in the application section was unfortunate.
  As also suggested by another reviewer, we decided to abstain from further discussing the Austrian election for the reasons outlined below:\\
...
institutes do not publish such details. However, one should be cautious with the Multinomial distribution assumption. One way to demonstrate a possible under-estimation of the variance is to display the realized voting results together with its posterior distribution.
  ...
  \\ \\
  \blue{Answer part 1}
Thank you for the detailed feedback! To adress these issues we included a
new Section 2.4 to discuss the handling of house and
industry biases as well as survey design, related issues regarding our model assumptions and the quality of estimates.\\

\todo[inline]{Add direct quote of Section 2.4 here}

\blue{Answer part 2} Additionally, you propose the evaluation of the approach based on final election outcomes.

\todo[inline]{Repost answer here}
...
page 3, paragraphs 2 and 3: Austria is  mentioned two times but no example from Austria is displayed. From my point of view the German examples are sufficient. Hence, one could skip the references to Austria.
  ...
  \\ \\
  \blue{Answer} Yes, mentioning Austria as an application example where our model was applied without showing results was unfortunate. We removed
  the reference to the Austrian election from the paper.
