...
In particular, these result from
...
we do not adjust the sample size of
the individual polling agencies in our approach, 
but use the sample sizes reported by them.
