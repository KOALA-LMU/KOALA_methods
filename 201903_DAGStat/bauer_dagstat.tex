...
\begin{center}
\includegraphics[width=0.5\textwidth]{figures/motivation_forsa_130109}
\end{center}
\bigskip \bigskip
\textbf{Goal} \\[0.1cm]
...
...
\\[0.4cm]
\textbf{What we} \redbf{do not} \textbf{aim for} \\[0.1cm]
...
}
...
\frame{\ft{\large{\blue{\ding{203}}} Methods}
\begin{center}
\includegraphics[width=0.5\textwidth]{figures/motivation_forsa_130109_bw}
\end{center}
\bigskip \bigskip
text
}
