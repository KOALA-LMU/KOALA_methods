...
\begin{enumerate}
  ...
  \item POE $= \frac{\#\text{event}}{\text{number of simulations}}$
\end{enumerate}
\bigskip \bigskip
\pause
...
\\[1.1cm]
\begin{center}
\animategraphics[height=150px]{10}{figures/gif/frame-}{0}{37}
\end{center}
\vspace{-15px}
...
\\[1.1cm]
\begin{center}
\includegraphics[height=150px]{figures/gif/frame-37}
\end{center}
\vspace{-15px}
{\footnotesize \textcolor{black!40}{I'm a .gif, click me (in Adobe Acrobat)!}}
}
...
\begin{frame}[fragile]
\ft{\large{\blue{\ding{203}}} Technical implementation}
\ft{\large{\blue{\ding{203}}} Technical implementation}
...
\frame{\ft{\large{\blue{\ding{206}}} Conclusion}
\vspace{5px}
\begin{center}
...
\begin{itemize}
  ...
  \item[]
  \item \bluebf{Keep in mind:} We do not make predictions
\end{itemize}
}
